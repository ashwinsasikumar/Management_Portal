        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200">
          {!sidebarCollapsed && (
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-lg" style={{background: 'linear-gradient(to bottom right, rgb(67, 113, 229), rgb(47, 93, 209))'}}>
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <div className="flex flex-col">
                <span className="text-lg font-bold" style={{background: 'linear-gradient(to right, rgb(67, 113, 229), rgb(47, 93, 209))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>CMS</span>
                <span className="text-xs text-gray-500 font-medium">Curriculum Portal</span>
              </div>
            </div>
          )}
          {!sidebarCollapsed && (
          ...
          {sidebarCollapsed && (
            ...
            >
              <div className="w-8 h-8 rounded-lg flex items-center justify-center shadow-md" style={{background: 'linear-gradient(to bottom right, rgb(67, 113, 229), rgb(47, 93, 209))'}}>
        ...
        <nav className="p-4 space-y-1">
          {menuItems.map((item) => (
            <button
              ...
              style={isActive(item.path) ? {backgroundColor: 'rgba(67, 113, 229, 0.1)', color: 'rgb(67, 113, 229)'} : {}}
            >
              {item.icon}
