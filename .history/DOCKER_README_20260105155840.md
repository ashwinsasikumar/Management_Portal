...
- Served with Nginx
- Port: 8082 (mapped to 80 inside container)
...
### MySQL Database
- MySQL 8.0
- Port: 3308 (mapped to 3306 inside container)
...
### Port conflicts
If ports 8082, 8080, or 3308 are already in use, modify the port mappings in `docker-compose.yml`:
```yaml
ports:
  - "8083:80"  # Change frontend port to 8083
```
