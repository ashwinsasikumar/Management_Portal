          ...
          <div className="card-custom p-6">
            ...
            <form onSubmit={handleAddCourse} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  value={(parseInt(newCourse.theory_hours) || 0) + (parseInt(newCourse.activity_hours) || 0) + (parseInt(newCourse.lecture_hours) || 0) + (parseInt(newCourse.tutorial_hours) || 0) + (parseInt(newCourse.practical_hours) || 0)}
                  readOnly
