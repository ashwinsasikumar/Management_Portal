              ...
              <ul className="timeline timeline-vertical">
                {logs.map((log, index) => (
                  <li key={log.id}>
                    ...
                    <div className="timeline-start timeline-box bg-gradient-to-r from-indigo-50 to-purple-50 border-2 border-indigo-200">
                      <div className="font-bold text-indigo-700 mb-1">{log.action}</div>
