...
function SyllabusPage() {
  ...
  const addTeamworkActivity = () => {
    setHeader({ 
      ...header, 
      teamwork: [...header.teamwork, { activity: '', points: 0, hours: 0 }] 
    })
  }
  ...
  const removeTeamworkActivity = (index) => {
    setHeader({ 
      ...header, 
      teamwork: header.teamwork.filter((_, i) => i !== index) 
    })
  }

  const updateTeamworkActivity = (index, field, value) => {
    const updated = [...header.teamwork]
    updated[index] = { ...updated[index], [field]: value }
    setHeader({ ...header, teamwork: updated })
  }
                  ...
                  <div className="flex-1 space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateTeamworkActivity(index, 'activity', e.target.value)}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateTeamworkActivity(index, 'points', parseInt(e.target.value) || 0)}
                          className="input-custom"
                          placeholder="0"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => updateTeamworkActivity(index, 'hours', parseInt(e.target.value) || 0)}
                          className="input-custom"
                          placeholder="0"
                        />
                      </div>
