...
function ManageCurriculumPage() {
  ...
  const [newSemester, setNewSemester] = useState({ semester_number: 1, name: '' })
  ...
  const handleCreateSemester = async (e) => {
    ...
    try {
      ...
      setNewSemester({ semester_number: 1, name: '' })
              ...
              <form onSubmit={handleCreateSemester} className="flex gap-4 items-end">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    placeholder="e.g., Semester 1 - Electives, Verticals, Open Elective Courses, One Credit Courses"
                    required
