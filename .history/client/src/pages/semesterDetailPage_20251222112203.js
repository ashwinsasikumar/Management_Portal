    ...
    try {
      const response = await fetch(`http://localhost:8080/api/regulation/${id}/semester/${semId}/course`, {
        ...
        body: JSON.stringify({
          ...
          total_hours: parseInt(newCourse.total_hours) || 0,
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/course/${editingCourse.id}`, {
        ...
        body: JSON.stringify({
          ...
          total_hours: parseInt(editCourseData.total_hours) || 0,
        ...
        {showAddForm && (
          <div className="card-custom p-6">
            ...
            <form onSubmit={handleAddCourse} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Practical</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Total Hrs</label>
                <input
                  type="number"
                  value={newCourse.total_hours}
                  onChange={(e) => setNewCourse({ ...newCourse, total_hours: e.target.value })}
                  placeholder="0"
                  min="0"
                  className="input-custom"
                />
              ...
              <form onSubmit={handleUpdateCourse} className="p-8 space-y-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={editCourseData.total_hours}
                      onChange={(e) => setEditCourseData({ ...editCourseData, total_hours: e.target.value })}
                      placeholder="0"
                      min="0"
                      className="input-custom"
                    />
