...
function SemesterDetailPage() {
  ...
  const newTotalHours =
    (parseInt(newCourse.lecture_hours) || 0) +
    (parseInt(newCourse.tutorial_hours) || 0) +
    (parseInt(newCourse.practical_hours) || 0)
  ...
  const editTotalHours =
    (parseInt(editCourseData.lecture_hours) || 0) +
            ...
            <form onSubmit={handleAddCourse} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Lab">Theory & Lab</option>
                </select>
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Theory (L)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Tutorial (T)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Activity (P)</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Total Hours (L + T + P)</label>
                <input
                  type="number"
                  value={newTotalHours}
                  readOnly
