            ...
            {semesters.map(sem => (
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Max Credits: {sem.max_credits}</p>
                  <span className="inline-block mt-2 px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-semibold rounded-full">Normal</span>
