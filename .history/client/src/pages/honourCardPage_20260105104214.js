          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div className="flex-1">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h1 className="text-3xl font-bold text-gray-900 mb-1">{honourCard.title}</h1>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-700 text-sm font-semibold rounded-full">
                      Semester {honourCard.semester_number}
                    </span>
                    <span className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-pink-100 to-pink-200 text-pink-700 text-sm font-semibold rounded-full">
                      🏆 Honour Programme
                    </span>
                  </div>
                </div>
            ...
            <button
              ...
              className="btn-primary-custom flex items-center gap-2 self-start"
            >
              {showVerticalForm ? (
                <>
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-xl font-bold text-white truncate">{vertical.name}</h3>
                        <div className="flex items-center gap-2 mt-1">
                          <span className="inline-flex items-center px-2 py-0.5 bg-pink-500 text-white text-xs font-bold rounded-full">
                            ...
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                              <div className="flex-1 min-w-0">
                                <div className="flex flex-wrap items-center gap-2 mb-3">
                                  <span className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-bold rounded-lg shadow-sm">
                                    {course.course_code}
                                  </span>
                                  <h4 className="font-bold text-gray-900 text-lg">{course.course_name}</h4>
                                </div>
                                <div className="flex flex-wrap gap-4 text-sm">
                                  <span className="flex items-center gap-1.5 text-gray-600">
                                    <span className="w-2 h-2 bg-pink-500 rounded-full flex-shrink-0"></span>
                                    <strong className="font-semibold">Credits:</strong> {course.credit}
                                  </span>
                                  <span className="flex items-center gap-1.5 text-gray-600">
                                    <span className="w-2 h-2 bg-pink-500 rounded-full flex-shrink-0"></span>
                                    <strong className="font-semibold">Type:</strong> {course.course_type}
                                  </span>
                                  <span className="flex items-center gap-1.5 text-gray-600">
                                    <span className="w-2 h-2 bg-pink-500 rounded-full flex-shrink-0"></span>
                              ...
                              <button
                                ...
                                className="px-4 py-2 bg-red-50 text-red-600 font-semibold rounded-lg hover:bg-red-100 transition-all duration-200 flex items-center gap-2 flex-shrink-0 self-start"
