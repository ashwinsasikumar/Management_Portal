        ...
        <div className="card-custom mb-8">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
            <div className="flex-1">
              <button
                onClick={() => navigate(`/regulation/${regulationId}/curriculum`)}
                className="text-purple-600 hover:text-purple-800 font-medium mb-4 flex items-center gap-2 transition-colors"
              >
              ...
              <div className="flex items-start gap-4">
                <span className="text-5xl sm:text-6xl flex-shrink-0">🎖️</span>
                <div className="flex-1 min-w-0">
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3">{honourCard.title}</h1>
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="inline-flex items-center px-3 py-1.5 bg-purple-100 text-purple-700 text-sm font-semibold rounded-full">
                      📚 Semester {honourCard.semester_number}
                    </span>
                    <span className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-pink-100 to-pink-200 text-pink-700 text-sm font-semibold rounded-full">
                      🏆 Honour Programme
                    </span>
                  </div>
                </div>
            ...
            <button
              ...
              className="btn-primary-custom flex items-center gap-2 self-start lg:self-auto"
            >
              {showVerticalForm ? (
                <>
