...
// CreateCourseSyllabusTable ensures course_syllabus exists (normalized - core fields only)
func CreateCourseSyllabusTable() error {
	...
	// Drop all legacy JSON columns
	_ = dropColumnIfExists("course_syllabus", "objectives")
	_ = dropColumnIfExists("course_syllabus", "outcomes")
	_ = dropColumnIfExists("course_syllabus", "reference_list")
	_ = dropColumnIfExists("course_syllabus", "prerequisites")
	_ = dropColumnIfExists("course_syllabus", "teamwork")
	_ = dropColumnIfExists("course_syllabus", "selflearning")
