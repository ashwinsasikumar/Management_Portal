...
func main() {
	...
	// Ensure courses columns exist (hours, marks, generated totals)
	if err := db.EnsureCoursesColumns(); err != nil {
		log.Println("Warning: EnsureCoursesColumns encountered issues:", err)
	}
