...
func GetClusterObjects(w http.ResponseWriter, r *http.Request) {
	...
	objects := models.ClusterObjects{
		ClusterID: clusterID,
		Mission:   fetchClusterList(clusterID, "cluster_mission", "mission_text"),
		PEOs:      fetchClusterList(clusterID, "cluster_peos", "peo_text"),
		POs:       fetchClusterList(clusterID, "cluster_pos", "po_text"),
		PSOs:      fetchClusterList(clusterID, "cluster_psos", "pso_text"),
	}
...
func SaveClusterObjects(w http.ResponseWriter, r *http.Request) {
	...
	saveClusterList(clusterID, "cluster_mission", "mission_text", objects.Mission)
	saveClusterList(clusterID, "cluster_peos", "peo_text", objects.PEOs)
	saveClusterList(clusterID, "cluster_pos", "po_text", objects.POs)
	saveClusterList(clusterID, "cluster_psos", "pso_text", objects.PSOs)
...
func saveClusterList(clusterID int, tableName, columnName string, items []string) error {
