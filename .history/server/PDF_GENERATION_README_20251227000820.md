...
The system uses `wkhtmltopdf` for HTML-to-PDF conversion. Install it based on your OS:
...
1. **"wkhtmltopdf not found"**
   - Install wkhtmltopdf as per instructions above
...
3. **"PDF conversion failed"**
   ...
   - Review backend logs for HTML rendering errors
